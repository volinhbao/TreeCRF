...
class Processor(DataProcessor):
    ...
    def __init__(self, logger, dataset, latent_size):
        ...
        if dataset == "ACE04" or dataset == "ACE05":
            ...
            self.labels = ['ADDRESS', 'DATETIME', 'DATETIME-DATE', 'DATETIME-DATERANGE',
            ...
            'PRODUCT-COM', 'PRODUCT-LEGAL', 'PRODUCT-AWARD', 'QUANTITY', 'QUANTITY-AGE', 'QUANTITY-CUR',
            'QUANTITY-DIM', 'QUANTITY-NUM', 'QUANTITY-ORD', 'QUANTITY-PER', 'QUANTITY-TEM',
            'SKILL', 'URL']
        else:
            raise NotImplementedError()

        if dataset == "ACE05" or dataset == "GENIA" or dataset == "ACE04" or dataset == "VLSP":
            self.interval = 4
        else:
            raise NotImplementedError()
